...
print('This is a program to print all alphabets from a to z using while loop.')
alphabet_a = 96 # Stores ascii value of a in alphabet_a.
...
while x < alphabet_z:  # while loop runs till x value is less then alphabet_z. 
    x = x + 1   # counter value x incrimented by one here.
