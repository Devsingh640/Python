...
file = open("profile.txt", mode = "w")	#This will first create a file if file not present and opens it in write mode.
...
file = open("profile.txt", mode = "r")	#This will open the required file in read mode.
