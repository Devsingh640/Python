...
for i in range(0, 10):	#This is a for loop.
    output = operation[desired_operator](float(numnerr), i)	#Stored the result in variable after using the operator on input number and number i generated by loop. 
